...
def save_model(
    ...
    checkpoint_paths = [
        output_dir / (f"checkpoint-{model_name}-{ratio}-{epoch_name}-CYXtest.pth") #修改训练模型的名称
    ]
    ...
    if is_main_process() and isinstance(epoch, int):
        ...
        old_ckpt = output_dir / (f"checkpoint-{model_name}-{ratio}-{to_del}-CYXtest.pth") #修改训练模型的名称
